...
def maximin_p2_FD(x: np.array) -> float:
    """
    Maximin function for p2 with a FD function
    :param x: Stationary strategy for player 2 who wishes to maximze
    :return: The maximin result for P2
    """
    ...
    upper_result_min = res_p2_min[0] * fd_upper_min
    down_result_min = res_p2_min[1] * fd_bottom_min

    return np.min([-upper_result_min, -down_result_min])
...
def maximin_p1_typei_fd():
    ...
    maxmin_p1_try1 = minimize(maximin_p1_FD, x_try_1, bounds=bnds_typei, constraints=con, options={'disp': False,
                                                                                                    ...
                                                                                                    'eps': 1,
                                                                                                    'maxiter': 100})
    save_x.append(maxmin_p1_try1.x)
    ...
    maxmin_p1_try2 = minimize(maximin_p1_FD, x_try_2, bounds=bnds_typei, constraints=con, options={'disp': False,
                                                                                                   ...
                                                                                                   'eps': 1,
                                                                                                   'maxiter': 100})
    save_x.append(maxmin_p1_try2.x)
    ...
    maxmin_p1_try3 = minimize(maximin_p1_FD, x_typei, bounds=bnds_typei, constraints=con, options={'disp': False,
                                                                                                    ...
                                                                                                    'eps': 0.1,
                                                                                                    'maxiter': 100})
    save_x.append(maxmin_p1_try3.x)
    save_values[2] = maxmin_p1_try3.fun

    found_value = np.max(save_values)
    found_value = -found_value

    index_value = np.where(-found_value == save_values)
    index_value = index_value[0]
    index_value = index_value[0]

    print("Player 1 wants to maximize his own payoff and plays:", save_x[index_value])
...
def maximin_p2_typei_fd():
    ...
    maxmin_p2_fd_try1 = minimize(maximin_p2_FD, x_try_1, bounds=bnds_typei, constraints=con, options={'disp': False,
                                                                                                    ...
                                                                                                    'eps': 0.1,
                                                                                                    'maxiter': 100})
    save_x.append(maxmin_p2_fd_try1.x)
    ...
    maxmin_p2_fd_try2 = minimize(maximin_p2_FD, x_try_2, bounds=bnds_typei, constraints=con, options={'disp': False,
                                                                                                      ...
                                                                                                      'eps': 0.1,
                                                                                                      'maxiter': 100})
    save_x.append(maxmin_p2_fd_try2.x)
    ...
    maxmin_p2_fd_try3 = minimize(maximin_p2_FD, x_typei, bounds=bnds_typei, constraints=con, options={'disp': False,
                                                                                                      ...
                                                                                                      'eps': 0.1,
                                                                                                      'maxiter': 100})
    save_x.append(maxmin_p2_fd_try3.x)
    ...
    print("Player 2 wants to maximize his own payoff and plays:", save_x[index_value])
