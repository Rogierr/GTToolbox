...
print("Now Playing Prisoners Dilemma")
Prisoners_Dilemma = RepeatedGame(p1_payoff_PD, p2_payoff_PD)
Prisoners_Dilemma.plot_single_period_pure_rewards(True, 'sb')
Prisoners_Dilemma.plot_all_rewards(points, True, 'sb')
# Prisoners_Dilemma.compute_threat_point(100000, True, True, True)
Prisoners_Dilemma.plot_pareto_rewards(points, True, 'sb')
...
print("")
print("")
print("Now Playing Stag Hunt")
Stag_Hunt = RepeatedGame(p1_payoff_SH, p2_payoff_SH)
Stag_Hunt.plot_single_period_pure_rewards(True, 'sb')
Stag_Hunt.plot_all_rewards(points, True, 'sb')
Stag_Hunt.plot_pareto_rewards(points, True, 'sb')
